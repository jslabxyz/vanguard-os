...
export default function DashboardChart() {
  ...
  const renderChart = (data: ChartDataPoint[]) => {
    return (
      <div className="bg-accent rounded-lg p-3" style={{ minHeight: 200 }}>
        <ChartContainer className="aspect-[2/1] md:aspect-[3/1] w-full" style={{ minHeight: 180 }} config={chartConfig}>
          <AreaChart
            accessibilityLayer
            data={data}
            margin={{
